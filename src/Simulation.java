...
public class Simulation {
	...
	Simulation(SimulationParams sParams) {
		...
		//float incrementX = SIZE.x / simParams.numTreesX; - static access cleanup. 2024-0625 STH
		float incrementX = SIZE.x / SimulationParams.numTreesX;
		//float incrementY = SIZE.y / simParams.numTreesY; - static access cleanup. 2024-0625 STH
		float incrementY = SIZE.y / SimulationParams.numTreesY;
		//for (int i = 0; i < simParams.numTreesX; i++) { - static access cleanup. 2024-0625 STH
		for (int i = 0; i < SimulationParams.numTreesX; i++) {
			//for (int j = 0; j < simParams.numTreesY; j++) { - static access cleanup. 2024-0625 STH
			for (int j = 0; j < SimulationParams.numTreesY; j++) {
